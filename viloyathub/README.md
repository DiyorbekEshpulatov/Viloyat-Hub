...
```
POST   /mentor/chat        # Yangi chat
POST   /mentor/chat/:id    # Chat davom ettirish
GET    /mentor/chats       # Chat tarixi
DELETE /mentor/chat/:id    # Chatni o'chirish
```

## Hududiy Xarita Endpoints

```
GET    /map/points         # Xarita nuqtalari
GET    /map/points/:id     # Nuqta detali
GET    /map/nearby         # Geolokatsiya bo'yicha yaqin nuqtalar
GET    /map/regions        # Viloyatlar ro'yxati
```

## Foydalanuvchi Endpoints

```
GET    /users/profile      # Profil ma'lumotlari
PUT    /users/profile      # Profil yangilash
GET    /users/stats        # Foydalanuvchi statistikasi
POST   /users/premium      # Premium ulanish
```
